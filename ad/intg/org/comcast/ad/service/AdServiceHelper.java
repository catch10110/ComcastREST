...
public class AdServiceHelper {
	...
	public static final TypeReference<List<CampaignModel>> tr_listCampaignModel = new TypeReference<List<CampaignModel>>() {};
	...
	public static <T> T ConvertJsonResponseToPojo(HttpResponse response, TypeReference<T> tr) throws JsonParseException, JsonMappingException, IOException {
		ObjectMapper mapper = new ObjectMapper();
		mapper.findAndRegisterModules();
		return mapper.readValue(response.getEntity().getContent(), tr);
	}
	
	public static <T> T ConvertJsonResponseToPojo(HttpResponse response, Class<T> cls) throws JsonParseException, JsonMappingException, IOException {
		ObjectMapper mapper = new ObjectMapper();
		mapper.findAndRegisterModules();
